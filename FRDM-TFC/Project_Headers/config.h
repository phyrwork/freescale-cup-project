...
#define TELEMETRY_REQUEST_FREQUENCY 250
#define WSPEED_REQUEST_INDEX 2
#define WSPEED_REQUEST_FREQUENCY 300
...
#define WSPEED_FILTER_COEFFS {0.0259,0.0357,0.0468,0.0588,0.0706,0.0809,0.0886,0.0927,0.0927,0.0886,0.0809,0.0706,0.0588,0.0468,0.0357,0.0259}
#define WSPEED_FILTER_ORDER 16
