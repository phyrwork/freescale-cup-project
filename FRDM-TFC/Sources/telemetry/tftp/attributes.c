...
TFTP_ENDPOINT_PUSH(TFTP_BEST_MATCH_ENDPOINT, TFTP_BEST_MATCH_CODE, TFTP_LINE_TYPE, TFTP_LINE_SIZE);
...
TFTP_ENDPOINT_PUSH(TFTP_CORNER_PROXIMITY_ENDPOINT, TFTP_CORNER_PROXIMITY_CODE, TFTP_CORNER_PROXIMITY_TYPE, TFTP_CORNER_PROXIMITY_SIZE);
