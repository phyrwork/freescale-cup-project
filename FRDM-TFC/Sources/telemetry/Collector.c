...
CollectorItem items[] = {
	...
	/* [5] = */ { /* data = */ &CadenceSensors[0].period, /* deref = */ 0, /* endpoint = */ &TFTP_W_RR_ENDPOINT,    /* frequency = */ 20, /* misc...*/ 0,0 },
	/* [5] = */ { /* data = */ &CadenceSensors[1].period, /* deref = */ 0, /* endpoint = */ &TFTP_W_RL_ENDPOINT,    /* frequency = */ 20, /* misc...*/ 0,0 },
};
