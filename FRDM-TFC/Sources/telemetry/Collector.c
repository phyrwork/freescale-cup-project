...
CollectorItem items[] = {
	...
	/* [4] = */ { /* data = */ &MotorCurrent[I_RL].value, /* deref = */ 0, /* endpoint = */ &TFTP_I_RL_ENDPOINT,    /* frequency = */ 100, /* misc...*/ 0,0 },
	/* [5] = */ { /* data = */ &MotorCurrent[I_RR].value, /* deref = */ 0, /* endpoint = */ &TFTP_I_RR_ENDPOINT,    /* frequency = */ 100, /* misc...*/ 0,0 }
};
