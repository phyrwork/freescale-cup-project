...
CollectorItem items[] = {
	...
	/* [5] = */ { /* data = */ &WheelSpeeds[0].value, /* deref = */ 0, /* endpoint = */ &TFTP_W_RR_ENDPOINT,    /* frequency = */ 20, /* misc...*/ 0,0 },
	/* [5] = */ { /* data = */ &WheelSpeeds[1].value, /* deref = */ 0, /* endpoint = */ &TFTP_W_RL_ENDPOINT,    /* frequency = */ 20, /* misc...*/ 0,0 },
};
