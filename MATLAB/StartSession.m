...
gui = gui.addViews(...
        LinescanView(session, 'linescan0', 'figure', 1, 'position', [2,5,1]),...
        TrackPositionView(session, 'TrackPosition', 'figure', 1, 'position', [2,5,6]),...
        ...
        MotorTorqueView(session, 'T*_rl', 'figure', 1, 'position', [2,5,2]),...
        MotorTorqueView(session, 'T*_rr', 'figure', 1, 'position', [2,5,7]),...
        ...
        MotorDutyView(session, 'D_rl', 'figure', 1, 'position', [2,5,3]),...
        MotorDutyView(session, 'D_rr', 'figure', 1, 'position', [2,5,8]),...
        ...
        MotorCurrentView(session, 'i_rl', 'figure', 1, 'position', [2,5,4]),...
        MotorCurrentView(session, 'i_rr', 'figure', 1, 'position', [2,5,9]),...
        ...
        MotorTorqueView(session, 'T_rl', 'figure', 1, 'position', [2,5,5]),...
        MotorTorqueView(session, 'T_rr', 'figure', 1, 'position', [2,5,10])...
      )
