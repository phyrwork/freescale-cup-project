...
gui = gui.addViews(...
        LinescanView(session, 'linescan0', 'figure', 1, 'position', [2,4,1]),...
        TrackPositionView(session, 'TrackPosition', 'figure', 1, 'position', [2,4,5]),...
        MotorCurrentView(session, 'i_rl', 'figure', 1, 'position', [2,4,4]),...
        MotorCurrentView(session, 'i_rr', 'figure', 1, 'position', [2,4,8]),...
        MotorTorqueView(session, 'T*_rl', 'figure', 1, 'position', [2,4,2]),...
        MotorTorqueView(session, 'T_rl', 'figure', 1, 'position', [2,4,3]),...
        MotorTorqueView(session, 'T*_rr', 'figure', 1, 'position', [2,4,6]),...
        MotorTorqueView(session, 'T_rr', 'figure', 1, 'position', [2,4,7])...
      )
