...
gui = gui.addViews(...
        LinescanView(session, 'linescan0', 'figure', 1, 'position', [2,2,1]),...
        TrackPositionView(session, 'TrackPosition', 'figure', 1, 'position', [2,2,3]),...
        MotorCurrentView(session, 'i_rl', 'figure', 1, 'position', [2,2,2]),...
        MotorCurrentView(session, 'i_rr', 'figure', 1, 'position', [2,2,4])...
      )
